...
<Header company="Heartfelt" bind:platformName bind:persistentHamburgerMenu bind:isSideNavOpen>
		...
		<HeaderAction icon={UserAvatarFilledAlt}>
			<HeaderPanelLinks>
				...
				{#if $user}
					...
					<HeaderPanelLink href="/info/about/project-overview"
						>About - Project Overview</HeaderPanelLink
					>
					...
					<HeaderPanelLink href="/info/technology/infrastructure"
						>Technology - Infrastructure</HeaderPanelLink
					>
